...
![智队搭 · 体验版二维码](docs/images/experience-qrcode.png)

- ⚠️ 当前是**体验版**：扫码后会提示申请体验权限，**我会尽快审核通过**（通过后即可正常进入）；
- ⏰ 二维码有效期至 **2026-09-27**，过期后重新生成并替换 `docs/images/experience-qrcode.png` 即可；
- 建议用微信「扫一扫」直接扫屏幕上的这张图；若提示"无体验权限"，说明审核还没通过。
...
界面截图按功能模块排列，与上表核心功能一一对应：

### 11.1 赛事大厅（首页）

![赛事大厅（首页）](docs/images/image.png)

### 11.2 邀请 / 申请动态

![邀请/申请动态页](docs/images/image-1.png)

### 11.3 创建队伍

![创建队伍表单](docs/images/image-2.png)

### 11.4 队伍招募大厅

![队伍招募大厅](docs/images/image-3.png)

### 11.5 赛事管理（管理员后台）

![管理员专属赛事管理页](docs/images/image-4.png)

### 11.6 个人中心

![个人中心](docs/images/image-5.png)

### 11.7 个人信息编辑

![个人信息编辑页](docs/images/image-6.png)

### 11.8 队伍详情

![队伍详情](docs/images/image-7.png)

### 11.9 智能匹配 · 个人匹配队伍成功

![个人去匹配队伍匹配成功的显示](docs/images/image-8.png)

### 11.10 智能匹配 · 队伍匹配队友成功

![队伍去匹配队友匹配成功的显示](docs/images/image-9.png)